...
<body class="dark-background">
    ...
    <section id="contact" class="contact section" >
        ...
        <!-- Section Title -->
        <div class="container section-title" style="margin-top: 100px !important;" data-aos="fade-up">
            <h2>Contact</h2>
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-6">
                    <div class="info-item d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div>
                            <h3>Address</h3>
                            <p>Darshan Restaurant, Veraval Rd, opp. Icici Bank, Keshod, Gujarat 362220</p>
                        </div>
                    </div>
                </div><!-- End Info Item -->
